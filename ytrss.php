 ...
 */
class JDocumentRendererFeedYtrss extends JDocumentRenderer
{
	/**
	 * Renderer mime type
	 *
	...
	public function render($name = '', $params = null, $content = null)
	{
		...
		$feed .= "		<yandex:analytics id=\"0000\" type=\"Yandex\"></yandex:analytics>\n";
		$feed .= "		<yandex:analytics id=\"0000\" type=\"Google\"></yandex:analytics>\n";
		...
		for ($i = 0, $count = count($data->items); $i < $count; $i++)
		{
			...
			$feed .= "			<turbo:content><![CDATA[" . $header . $this->_relToAbs($data->items[$i]->description) . "]]></turbo:content>\n";
